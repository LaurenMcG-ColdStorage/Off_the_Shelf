...
router.post('/', (req, res) => {
    //This will add historical logs to the database
    ...
    //Query One: Check for game in database, get the id from the title we have
    pool
    ...
    .then((result) => {
        ...
        //Query Two: Add data into history table
        pool
        .query(presentQuery, logSession)
        .then((result) => {
            //Query Three: Update game played column within collection_game table
            pool
